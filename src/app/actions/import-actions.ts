    ...
    try {
        ...
        for (const [awbKey, recipientRows] of awbsMap.entries()) {
            ...
            const awbData: Partial<AWB> = {
                ...
                mainRecipientTelephone: String(firstRow[reverseMapping['awbTelephone']]),
            ...
            for (const row of recipientRows) {
                const recipientNumericId = String(row[reverseMapping['recipientId']]);
                ...
                const recipientData: Partial<Recipient> = {
                    id: recipientId, // This is the unique firestore ID
                    uuid: randomUUID(), // Autogenerated UUID
                    numericId: recipientNumericId, // This is the original ID from the file
                    shipmentId: shipmentId,
                    awbId: awbId,
                    ...
                    telephone: String(row[reverseMapping['telephone']]), // Ensuring it's a string
